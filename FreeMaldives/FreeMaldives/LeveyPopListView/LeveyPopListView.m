...
- (void)drawRect:(CGRect)rect
{
    ...
    CGRect titleRect = CGRectMake(POPLISTVIEW_SCREENINSET + 10, POPLISTVIEW_SCREENINSET + 5 + 5,
                                  rect.size.width -  2 * (POPLISTVIEW_SCREENINSET + 10), 30);
    CGRect separatorRect = CGRectMake(POPLISTVIEW_SCREENINSET, POPLISTVIEW_SCREENINSET + POPLISTVIEW_HEADER_HEIGHT - 8,
    ...
    float height = bgRect.size.height - 100;
    ...
    [[UIColor colorWithRed:1.020 green:1.549 blue:1.961 alpha:1.] setFill];
